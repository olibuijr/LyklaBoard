...
fun HomeScreen() = FlorisScreen {
    ...
    content {
        ...
        Preference(
            ...
            title = stringRes(R.string.lyklabord__dictionary__home_title),
            onClick = { navController.navigate(Routes.Settings.LyklabordDictionary) },
        )
        Preference(
            icon = Icons.Outlined.Settings,
            title = stringRes(R.string.lyklabord__settings__home_title),
            onClick = { navController.navigate(Routes.Settings.LyklabordSettings) },
        )
        Preference(
