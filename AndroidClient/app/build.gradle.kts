...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        applicationId = "is.solberg.lyklabord"
    ...
    androidResources {
        // Keep the Lyklaborð runtime artifacts uncompressed so they can be
        // memory-mapped via AssetManager.openFd (mmap-and-lazy-read readers).
        noCompress += listOf("lex", "bin")
    }
...
dependencies {
    ...
    implementation(projects.lib.engine)
